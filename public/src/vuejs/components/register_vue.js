const allErrorSignUp = {
    undefined : '',
    0 : 'Fill empty field',
    1 : 'Valid', //valid return
    2 : 'Password fields are different',
    3 : 'Email fields are different',
    4 : 'Invalid Username',
    5 : 'Invalid Email',
    6 : 'This email already exist',
    7 : 'Invalid Password',
    8 : 'Invalid Region',
    9 : 'Invalid Country',
    10 : 'Invalid Fortnite city',
    11 : 'Invalid Platform',
    12 : 'Invalid Language',
    13 : 'Please select captcha',
    21 : 'Login already exist',
    22 : 'Email already exist',
    26 : 'Login not found',
    27 : 'Error password',
    28 : 'You need to activate your account. Check your email',
    29 : 'Epic account already exist',
    31 : 'Epic account not found with this platform',
    33 : 'Epic account not found with this platform',
	34 : 'Epic account not found with this platform',
    41 : 'An error occured during email sending',
    51 : 'already current login user',
    52 : 'You need to choose a differente password'
}

const allRegions = [
    { region: 'north America', value: 'NAM' },
    { region: 'europe', value: 'EUR' },
    { region: 'brazil', value: 'BRA' },
    { region: 'oceania', value: 'OCN' },
    { region: 'japan', value: 'JPA' },
    { region: 'korea', value: 'KOR' },
];

const allCitys = [
    { city: 'dusty divot', value: 'dusty' },
    { city: 'fatal fields', value: 'fatal' },
    { city: 'flush factory', value: 'flush' },
    { city: 'greasy groove', value: 'greasy' },
    { city: 'haunted hills', value: 'haunted' },
    { city: 'lazy links', value: 'lazy' },
    { city: 'lonely lodge', value: 'lonely' },
    { city: 'lucky landing', value: 'lucky' },
    { city: 'junk junction', value: 'junk' },
    { city: 'paradise palms', value: 'paradise' },
    { city: 'pleasant park', value: 'pleasant' },
    { city: 'retail row', value: 'retail' },
    { city: 'risky reels', value: 'risky' },
    { city: 'salty springs', value: 'salty' },
    { city: 'shifty shafts', value: 'shifty' },
    { city: 'snobby shores', value: 'snobby' },
    { city: 'tilted tower', value: 'tilted' },
    { city: 'wailing woods', value: 'wailing' }
];
...
const allPlatforms = [
    ...
    { platform: 'playstation 4', value: 'PS4' },
    { platform: 'xbox one', value: 'XB1' },
    { platform: 'switch', value: 'SW' },
    { platform: 'mobile', value: 'SM' }
];
